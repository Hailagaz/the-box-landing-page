...
"use strict";function windowLoad(){function n(e){e=e||document.querySelectorAll("[data-digits-counter]");e&&e.forEach(e=>{{var n=e;let t=null;const r=parseInt(n.dataset.digitsCounter)?parseInt(n.dataset.digitsCounte):1e3,o=parseInt(n.innerHTML),a=e=>{t=t||e;e=Math.min((e-t)/r,1);n.innerHTML=Math.floor(e*(0+o)),e<1&&window.requestAnimationFrame(a)};window.requestAnimationFrame(a)}})}let t=new IntersectionObserver((e,t)=>{e.forEach(e=>{e.isIntersecting&&(e=e.target.querySelectorAll("[data-digits-counters]")).length&&n(e)})},{threshold:.1});var e=document.querySelectorAll(".stats");e.length&&e.forEach(e=>{t.observe(e)})}window.addEventListener("load",windowLoad);
