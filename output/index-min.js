...
fetch("js/featureProjects.json").then(e=>e.json()).then(e=>{let r="";for(var i of e)r+=`
				<div class="swiper-slide hero__slide">
					<div class="hero__photo">
						<img src="${i.photo}" alt="Photo of build project">
					</div>
